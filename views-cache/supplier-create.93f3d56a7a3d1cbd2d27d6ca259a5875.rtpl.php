            ...
            <form action="/Fornecedor/CadastroFornecedor" method="post">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="idCpf" name="cpf_cnpj">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="idTipoClie">Tipo de Fornecedor<i class="importante">*</i></label>
                        <select id="idTipoClie" name="tipo_fornecedor" class="form-control">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="telefone" id="idTelefone" maxlength="14" OnKeyPress="formatar('##-# ####-####', this)">
                    </div>
