<?php if(!class_exists('Rain\Tpl')){exit;}?>            <h2 class="mb-4">Bem vindo, <?php echo htmlspecialchars( $name, ENT_COMPAT, 'UTF-8', FALSE ); ?></h2>
                            ...
                            <tr>
                                <td colspan="3">
                                    <div class="text-right text-muted" style="padding-top:9px">
                                        <i>
                                        <a class="text-muted" href="/NovoOrcamento"><i class="fa fa-angle-double-right margin-right-5px"></i>Novo Orçamento</a>
                                        </i>
                                    </div>
                                </td>
                            </tr>
